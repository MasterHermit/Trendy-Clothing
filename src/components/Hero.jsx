      ...
      <div className="hero-content text-center">
        <div className="max-w-xl">
          ...
          <p className="py-6 text-2xl max-md:text-lg text-accent-content">
            ...
            Discover the Art of Fashion at , Trendy
            where every stitch and step tell a story.
            Elevate your wardrobe, one ensemble at a time.
            Your journey to exceptional fashion starts here.
          </p>
